...
//  PersonAuthenticationApp
//
//  Created by Srinija on 27/02/18.
//  Copyright © 2018 PersonAuthentication. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //Initializes the SDK. Please use the 'appId' and 'appKey' values provided by PersonAuthentication
        PersonAuthentication.initialize(appId: appId, appKey: appKey, region: HyperSnapParams.Region.AsiaPacific, product: HyperSnapParams.Product.faceID)
